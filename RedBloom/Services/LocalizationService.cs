...
public static class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["L_Edit"] = "Edit",
        ["L_Delete"] = "Delete",
        ["L_DeleteConfirm"] = "Delete {0}? This cannot be undone.",
        ["L_DeleteThis"] = "this",
        ["L_CollapseSidebarTip"] = "Collapse the sidebar (Ctrl+Shift+B)",
        ["L_FilesTip"] = "Browse and edit files",
        ["L_FilesAll"] = "All files",
        ["L_FilesRecent"] = "Changed",
        ["L_FilesRecentTip"] = "Files recently changed by agents",
        ["L_FilesUp"] = "Up a folder",
        ["L_FilesPathTip"] = "Type a path and press Enter to go there",
        ["L_FilesNone"] = "Nothing here yet.",
        ["L_FilesFolder"] = "folder",
        ["L_FilesSave"] = "Save",
        ["L_FilesSaved"] = "saved",
        ["L_FilesPreview"] = "Preview",
        ["L_FilesEdit"] = "Edit",
        ["L_FilesBold"] = "Bold",
        ["L_FilesItalic"] = "Italic",
        ["L_FilesStrike"] = "Strikethrough",
        ["L_FilesHeading"] = "Heading",
        ["L_FilesQuote"] = "Quote",
        ["L_FilesList"] = "List",
        ["L_FilesInlineCode"] = "Inline code",
        ["L_FilesCodeBlock"] = "Code block",
        ["L_FilesLink"] = "Link",
        ["L_FilesImage"] = "Insert image",
        ["L_ImportTip"] = "Import chats from Claude Code",
        ["L_ImportTitle"] = "Import chats",
        ["L_ImportClaudeNote"] = "Past Claude Code sessions on this machine. The chosen ones are added under the Claude CLI agent; the tool calls and reasoning are left out.",
        ["L_ImportSelectAll"] = "Select all",
        ["L_ImportFound"] = "{0} sessions found",
        ["L_ImportMessages"] = "{0} messages",
        ["L_ImportScanning"] = "Scanning sessions… {0} / {1}",
        ["L_ImportImporting"] = "Importing… {0} / {1}",
        ["L_ImportInto"] = "Import into",
        ["L_ImportAssistant"] = "Assistant",
        ["L_ImportNewRoom"] = "New room",
        ["L_ImportRoomPrefix"] = "Room: {0}",
        ["L_ImportNone"] = "No sessions to import.",
        ["L_ImportAction"] = "Import",
        ["L_ImportNoClaude"] = "No Claude Code history was found on this machine.",
        ["L_ImportDone"] = "Imported {0} chats.",
        ["L_FilesGone"] = "This file is gone.",
        ["L_FilesTooBig"] = "Too large to open here.",
        ["L_FilesBinary"] = "Binary file — shown read-only.",
        ...
        ["L_InputControlling"] = "Agent is controlling input — Ctrl+Alt+Pause to stop",
        ["L_InputPaused"] = "Input paused. Agents were stopped.",
        ["L_InputResume"] = "Resume",
        ["L_ConfirmCloseWindow"] = "The agent wants to close a window (unsaved work may be lost).",
        ["L_ConfirmMouse"] = "Let the agent control the mouse — move, click and drag on your screen?",
        ...
        ["L_AiMultiply"] = "⧉ Multiply agent",
        ["L_AiMultiplyTip"] = "Duplicate this agent on the same endpoint — set the copy to another model. Copies show as \"name [model]\".",
        ...
        ["L_AiVision"] = "This model can see images",
        ["L_AiVisionNote"] = "On for models that read screenshots. Turn off for a text-only model — screenshots are then turned into text by on-device OCR.",
        ...
        ["L_RoomNew"] = "New room",
        ["L_ProjectsTab"] = "Projects",
        ["L_ProjectNone"] = "No projects yet.",
        ["L_ProjectNew"] = "New project",
        ["L_ProjectOpenFolder"] = "Open folder",
        ["L_ProjectChats"] = "CHATS",
        ["L_ProjectRooms"] = "ROOMS",
        ["L_ProjectFiles"] = "FILES",
        ["L_ProjectNewChat"] = "+ New chat",
        ["L_ProjectNewRoom"] = "+ New room",
        ["L_ProjectRefresh"] = "Refresh",
        ["L_ProjectNoChats"] = "No chats in this project yet.",
        ["L_ProjectNoRooms"] = "No rooms in this project yet.",
        ["L_ProjectNoFiles"] = "The project folder is empty.",
        ["L_ProjectDescHint"] = "What is this project about?",
        ["L_ProjectNeedAgent"] = "Add an AI agent first — set one up in the AI panel.",
        ["L_ChatPickTitle"] = "New chat",
        ["L_ChatPickHint"] = "Choose the model for this chat. It opens filed under the project.",
        ["L_ChatPickCreate"] = "Create",
        ["L_ProjectDialogTitle"] = "New project",
        ["L_ProjectName"] = "Name",
        ["L_ProjectDescription"] = "Description (optional)",
        ["L_ProjectDialogNote"] = "A folder is created for the project under your RedBloom Projects folder.",
        ["L_ProjectCreate"] = "Create",
        ["L_ProjectGraph"] = "Relationship tree",
        ["L_ProjectExpand"] = "Expand",
        ["L_ProjectInfo"] = "Project info",
        ["L_ProjectInfoEmpty"] = "No notes yet. Click Expand to write project info in Markdown.",
        ["L_ProjectPreview"] = "Preview",
        ["L_ProjectEdit"] = "Edit",
        ["L_MoveToProject"] = "Move to project",
        ["L_RemoveFromProject"] = "Remove from project",
        ["L_MovedTo"] = "Moved to “{0}”.",
        ["L_MovedOut"] = "Removed from project.",
        ["L_StatChats"] = "chats",
        ["L_StatRooms"] = "rooms",
        ["L_StatFiles"] = "files",
        ["L_StatClean"] = "no changes",
        ["L_StatChanges"] = "{0} changed",
        ["L_StatLastActivity"] = "last activity",
        ["L_StatJustNow"] = "just now",
        ["L_StatMinutesAgo"] = "{0} min ago",
        ["L_StatHoursAgo"] = "{0} h ago",
        ["L_StatDaysAgo"] = "{0} d ago",
        ["L_SourcesTitle"] = "SOURCES",
        ["L_SourcesAdd"] = "Add",
        ["L_SourcesNone"] = "No linked sources. Add a folder, a Visual Studio solution, or a GitHub repo.",
        ["L_SourceLocal"] = "Local folder…",
        ["L_SourceVs"] = "Visual Studio…",
        ["L_SourceGitHub"] = "GitHub…",
        ["L_SourceOpen"] = "Open",
        ["L_SourceRemove"] = "Remove",
        ["L_SourceOpenVs"] = "Open in Visual Studio",
        ["L_SourceClone"] = "Clone into project",
        ["L_SourceAddBtn"] = "Add",
        ["L_Publish"] = "Publish",
        ["L_ProjectPublishing"] = "Publishing…",
        ["L_ProjectPublished"] = "Published.",
        ["L_ProjectPublishFailed"] = "Publish failed.",
        ["L_StatLoc"] = "lines of code",
        ["L_StatComplexity"] = "complexity",
        ["L_StatConnections"] = "connections",
        ["L_StatNodes"] = "nodes",
        ["L_StatIsolated"] = "unconnected",
        ["L_StatTopNode"] = "busiest",
        ["L_CxLow"] = "Low",
        ["L_CxMedium"] = "Medium",
        ["L_CxHigh"] = "High",
        ["L_CxVeryHigh"] = "Very high",
        ["L_PublishTitle"] = "Publish to GitHub",
        ["L_PublishConfirm"] = "Publish this project folder to a new PRIVATE GitHub repository “{0}”?",
        ["L_PublishRepoFailed"] = "Could not create the repository. Your token needs repo write access.",
        ["L_PublishDone"] = "Published to {0}.",
        ["L_PublishUpdate"] = "Update",
        ["L_UpdateConfirm"] = "Commit and push the project's changes to “{0}”?",
        ["L_UpdateDone"] = "Pushed to {0}.",
        ["L_PubPublishTitle"] = "Publish to GitHub",
        ["L_PubUpdateTitle"] = "Update on GitHub",
        ["L_PubName"] = "Repository name",
        ["L_PubVisibility"] = "Visibility",
        ["L_PubPrivate"] = "Private",
        ["L_PubPublic"] = "Public",
        ["L_PubMessage"] = "Commit message",
        ["L_PubChanges"] = "Changes ({0})",
        ["L_PubNoChanges"] = "No changes to commit.",
        ["L_PubUpdating"] = "Updating {0}",
        ["L_PubImportAll"] = "Publish all files",
        ["L_PubImportAllHint"] = "Every file goes out, except build output (bin, obj, .vs) — the way Visual Studio publishes.",
        ["L_PubMetaOnlyHint"] = "Only project data goes out: connections, description, and chats and rooms. Source code stays local.",
        ["L_VsPickTitle"] = "Visual Studio solutions",
        ["L_VsPickHint"] = "Solutions found in your source\\repos folder and Visual Studio's recent list.",
        ["L_VsPickNone"] = "No solutions found. Add the folder as a local source instead.",
        ["L_GhDisconnect"] = "Sign out",
        ["L_GhTokenLabel"] = "Personal access token",
        ["L_GhConnect"] = "Connect",
        ["L_GhTokenHint"] = "Create a token with repository read access at ",
        ["L_GhLoading"] = "Loading repositories…",
        ["L_GhPrivate"] = "private",
        ["L_GhSettingsNote"] = "Sign in to link your repositories to projects.",
        ["L_GhSignIn"] = "Sign in with GitHub",
        ["L_GhSignInHint"] = "Opens GitHub in your browser — no token to create or paste.",
        ["L_GhOrToken"] = "OR SIGN IN WITH A TOKEN",
        ["L_GhSignInTitle"] = "Sign in to GitHub",
        ["L_GhDeviceIntro"] = "Open GitHub and enter this code to connect RedBloom:",
        ["L_GhDeviceOpen"] = "Open GitHub & copy code",
        ["L_GhDeviceStarting"] = "Requesting a code…",
        ["L_GhDeviceWaiting"] = "Waiting for confirmation in the browser…",
        ["L_GhPickTitle"] = "Pick a repository",
        ["L_GhNotConnected"] = "Not signed in. Connect your GitHub account in Settings first.",
        ["L_GhReauth"] = "Your GitHub sign-in has expired. Open Settings and sign in again. (If it keeps expiring, turn off \"Expire user authorization tokens\" in your OAuth App on GitHub.)",
        ["L_GhNoRepos"] = "No repositories found for this account.",
        ["L_GraphNode"] = "Node",
        ["L_GraphNote"] = "Note",
        ["L_GraphLabel"] = "Label",
        ["L_GraphDesc"] = "Description",
        ["L_GraphConnection"] = "Connection",
        ["L_GraphWidth"] = "Width",
        ["L_GraphDashed"] = "Dashed line",
        ["L_GraphArrow"] = "Arrow (direction)",
        ["L_GraphColor"] = "Colour",
        ["L_GraphCustomColor"] = "Custom colour",
        ["L_GraphRemoveColor"] = "Remove colour",
        ["L_GraphExport"] = "Export as image",
        ["L_GraphDefault"] = "Default",
        ["L_GraphOpen"] = "Open",
        ["L_GraphFit"] = "Fit",
        ["L_GraphHint"] = "Drag from a node's dot to connect. Click a node or line to edit.",
        ["L_GraphKindNote"] = "Note",
        ["L_GraphKindChat"] = "Chat",
        ["L_GraphKindRoom"] = "Room",
        ["L_GraphKindFile"] = "File",
        ["L_GraphKindSource"] = "Source",
        ["L_GraphKindFolder"] = "Folder",
        ["L_GraphKindMilestone"] = "Milestone",
        ["L_RoomTitle"] = "Room",
        ["L_RoomName"] = "Name",
        ["L_RoomParticipants"] = "Participants",
        ["L_RoomAddModel"] = "＋ Model",
        ["L_RoomAddModelTip"] = "Add a copy of an agent for another model, just for this room",
        ["L_RoomAddModelNone"] = "No endpoint agents to copy. Add one on the AI page first.",
        ["L_RoomAvatarNone"] = "no picture",
        ["L_RoomKindImage"] = "images",
        ["L_RoomKindLocal"] = "local",
        ["L_RoomEarlierSummary"] = "(earlier conversation summarised)",
        ["L_RoomContextPerTurn"] = "Context / turn",
        ["L_RoomAllowCommands"] = "Let agents run commands",
        ["L_RoomAllowCommandsNote"] = "The cast in this room may run commands on the machine. Off unless you turn it on.",
        ["L_RoomAskBeforeRun"] = "Ask before each command",
        ...
        ["L_RoomQueued"] = "Queued — it will be sent when the current exchange finishes.",
        ...
        ["L_ChatOpenTab"] = "Open",
        ["L_ChatExportMd"] = "Export to Markdown…",
        ["L_ChatOpenWorkspace"] = "Open chat folder",
        ["L_ChatCardStyle"] = "Appearance…",
        ["L_ChatExported"] = "Chat exported.",
        ...
        ["L_ExtensionsNote"] = "Add-ons that extend RedBloom. Turn one on, then open it in its own tab.",
        ["L_ExtEnabled"] = "Enabled",
        ["L_ExtOpen"] = "Open",
        ["L_ExtDocs"] = "Documentation",
        ["L_ExtFolder"] = "Extensions folder",
        ["L_ExtNone"] = "No extensions found. Drop one into the extensions folder.",
        ["L_ExtBuiltIn"] = "built-in",
        ["L_ExtUser"] = "user",
        ...
        ["L_ChatSend"] = "Send",
        ["L_ChatDropFiles"] = "Drop files to attach",
        ["L_ChatRevert"] = "Revert",
        ["L_ChatReverted"] = "Reverted",
        ...
        ["L_ChatAskPlaceholder"] = "Type your own answer…",
        ["L_ChatAskSend"] = "Send",
        ...
        ["L_ChatCmdExport"] = "export",
        ["L_ChatCmdExportHint"] = "Save this chat as a Markdown file",
        ["L_ChatExportTitle"] = "Export chat",
        ["L_ChatExportYou"] = "You",
        ["L_ChatExportEmpty"] = "Nothing to export yet.",
        ["L_ChatExported"] = "Exported to {0}.",
        ["L_ChatExportedProject"] = "Exported to the project · {0}.",
        ["L_ChatExportFailed"] = "Could not export: {0}",
        ["L_ChatCtxCopy"] = "Copy",
        ["L_ChatCtxImage"] = "Copy as image",
        ["L_ChatCtxGoToFile"] = "Go to file",
        ["L_ChatCtxWeb"] = "Search the web",
        ["L_ChatCtxAsk"] = "Ask the agent about this",
        ["L_ChatCtxAskOther"] = "Ask another agent…",
        ["L_ChatQuote"] = "Quote",
        ["L_ChatReply"] = "Reply to this one",
        ["L_ChatQuoteMe"] = "You",
        ["L_ChatMentionAll"] = "Everyone",
        ["L_ChatMentionAllTitle"] = "Address everyone again",
        ["L_ChatEarlier"] = "Show earlier ({0})",
        ["L_ChatEditing"] = "editing",
        ["L_ChatCancelEdit"] = "Cancel edit",
        ["L_ChatCompacting"] = "Compacting history…",
        ["L_TasksButton"] = "Tasks",
        ["L_TaskAgentButton"] = "Agent notebooks",
        ["L_TaskAgentNone"] = "This agent has no tasks yet.",
        ["L_TaskFilterOpen"] = "Unfinished only",
        ["L_TaskAdd"] = "Add",
        ["L_TaskDelete"] = "Delete",
        ["L_TaskShareOne"] = "Share this task with the agent",
        ["L_TaskShareAll"] = "Share all",
        ["L_TaskShareHeader"] = "Here is the task list:",
        ["L_TaskNone"] = "No tasks yet.",
        ["L_TaskNamePh"] = "Task name",
        ["L_TaskDescPh"] = "Description",
        ["L_TaskUnassigned"] = "— nobody —",
        ["L_TaskNotStarted"] = "Not started",
        ["L_TaskInProgress"] = "In progress",
        ["L_TaskDone"] = "Done",
        ["L_TaskNeedsRework"] = "Needs rework",
        ["L_TaskTests"] = "Tests",
        ["L_ChatNoSsh"] = "There are no saved SSH connections to attach.",
        ["L_ChatCompactNothing"] = "There is not enough here to compact yet.",
        ["L_ChatTrimmed"] = "The earliest part of this chat was dropped to fit the model's context.",
        ...
        ["L_PhaseReadingFile"] = "reading a file",
        ["L_PhaseWritingFile"] = "editing a file",
        ["L_PhaseTasks"] = "updating the task list",
        ...
        ["L_PhaseReconnecting"] = "the provider had a hiccup — reconnecting",
        ["L_FitGood"] = "runs well",
        ["L_FitTight"] = "tight",
        ["L_FitHeavy"] = "heavy",
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>
    {
        ...
        ["L_Edit"] = "Изменить",
        ["L_Delete"] = "Удалить",
        ["L_DeleteConfirm"] = "Удалить {0}? Это действие необратимо.",
        ["L_DeleteThis"] = "это",
        ["L_CollapseSidebarTip"] = "Свернуть боковую панель (Ctrl+Shift+B)",
        ["L_FilesTip"] = "Просмотр и редактирование файлов",
        ["L_FilesAll"] = "Все файлы",
        ["L_FilesRecent"] = "Изменено",
        ["L_FilesRecentTip"] = "Файлы, недавно изменённые агентами",
        ["L_FilesUp"] = "На папку вверх",
        ["L_FilesPathTip"] = "Введите путь и нажмите Enter",
        ["L_FilesNone"] = "Здесь пока пусто.",
        ["L_FilesFolder"] = "папка",
        ["L_FilesSave"] = "Сохранить",
        ["L_FilesSaved"] = "сохранено",
        ["L_FilesPreview"] = "Просмотр",
        ["L_FilesEdit"] = "Правка",
        ["L_FilesBold"] = "Жирный",
        ["L_FilesItalic"] = "Курсив",
        ["L_FilesStrike"] = "Зачёркнутый",
        ["L_FilesHeading"] = "Заголовок",
        ["L_FilesQuote"] = "Цитата",
        ["L_FilesList"] = "Список",
        ["L_FilesInlineCode"] = "Код в строке",
        ["L_FilesCodeBlock"] = "Блок кода",
        ["L_FilesLink"] = "Ссылка",
        ["L_FilesImage"] = "Вставить картинку",
        ["L_ImportTip"] = "Импорт чатов из Claude Code",
        ["L_ImportTitle"] = "Импорт чатов",
        ["L_ImportClaudeNote"] = "Прошлые сессии Claude Code на этой машине. Выбранные добавятся под агента Claude CLI; вызовы инструментов и рассуждения не переносятся.",
        ["L_ImportSelectAll"] = "Выбрать все",
        ["L_ImportFound"] = "Найдено сессий: {0}",
        ["L_ImportMessages"] = "сообщений: {0}",
        ["L_ImportScanning"] = "Сканирую сессии… {0} / {1}",
        ["L_ImportImporting"] = "Импортирую… {0} / {1}",
        ["L_ImportInto"] = "Импортировать в",
        ["L_ImportAssistant"] = "Ассистент",
        ["L_ImportNewRoom"] = "Новая комната",
        ["L_ImportRoomPrefix"] = "Комната: {0}",
        ["L_ImportNone"] = "Нет сессий для импорта.",
        ["L_ImportAction"] = "Импорт",
        ["L_ImportNoClaude"] = "История Claude Code на этой машине не найдена.",
        ["L_ImportDone"] = "Импортировано чатов: {0}.",
        ["L_FilesGone"] = "Файл исчез.",
        ["L_FilesTooBig"] = "Слишком большой для просмотра здесь.",
        ["L_FilesBinary"] = "Бинарный файл — только чтение.",
        ...
        ["L_InputControlling"] = "Агент управляет вводом — Ctrl+Alt+Pause чтобы остановить",
        ["L_InputPaused"] = "Ввод приостановлен. Агенты остановлены.",
        ["L_InputResume"] = "Возобновить",
        ["L_ConfirmCloseWindow"] = "Агент хочет закрыть окно (несохранённое может быть потеряно).",
        ["L_ConfirmMouse"] = "Разрешить агенту управлять мышью — двигать, кликать и перетаскивать на экране?",
        ...
        ["L_AiMultiply"] = "⧉ Размножить агента",
        ["L_AiMultiplyTip"] = "Дубликат агента на том же эндпоинте — задай копии другую модель. Копии показываются как «имя [модель]».",
        ...
        ["L_AiVision"] = "Модель видит изображения",
        ["L_AiVisionNote"] = "Включено для моделей, читающих скриншоты. Отключите для текстовой модели — тогда скриншоты превращаются в текст локальным OCR.",
        ...
        ["L_ProjectsTab"] = "Проекты",
        ["L_ProjectNone"] = "Пока нет проектов.",
        ["L_ProjectNew"] = "Новый проект",
        ["L_ProjectOpenFolder"] = "Открыть папку",
        ["L_ProjectChats"] = "ЧАТЫ",
        ["L_ProjectRooms"] = "КОМНАТЫ",
        ["L_ProjectFiles"] = "ФАЙЛЫ",
        ["L_ProjectNewChat"] = "+ Новый чат",
        ["L_ProjectNewRoom"] = "+ Новая комната",
        ["L_ProjectRefresh"] = "Обновить",
        ["L_ProjectNoChats"] = "В этом проекте пока нет чатов.",
        ["L_ProjectNoRooms"] = "В этом проекте пока нет комнат.",
        ["L_ProjectNoFiles"] = "Папка проекта пуста.",
        ["L_ProjectDescHint"] = "О чём этот проект?",
        ["L_ProjectNeedAgent"] = "Сначала добавь AI-агента — настрой его в AI-панели.",
        ["L_ChatPickTitle"] = "Новый чат",
        ["L_ChatPickHint"] = "Выберите модель для чата. Он откроется внутри проекта.",
        ["L_ChatPickCreate"] = "Создать",
        ["L_ProjectDialogTitle"] = "Новый проект",
        ["L_ProjectName"] = "Название",
        ["L_ProjectDescription"] = "Описание (необязательно)",
        ["L_ProjectDialogNote"] = "Для проекта создаётся папка в каталоге RedBloom Projects.",
        ["L_ProjectCreate"] = "Создать",
        ["L_ProjectGraph"] = "Дерево связей",
        ["L_ProjectExpand"] = "Развернуть",
        ["L_ProjectInfo"] = "Информация о проекте",
        ["L_ProjectInfoEmpty"] = "Пока пусто. Нажми «Развернуть», чтобы написать информацию о проекте в Markdown.",
        ["L_ProjectPreview"] = "Просмотр",
        ["L_ProjectEdit"] = "Правка",
        ["L_MoveToProject"] = "Перенести в проект",
        ["L_RemoveFromProject"] = "Убрать из проекта",
        ["L_MovedTo"] = "Перенесено в «{0}».",
        ["L_MovedOut"] = "Убрано из проекта.",
        ["L_StatChats"] = "чаты",
        ["L_StatRooms"] = "комнаты",
        ["L_StatFiles"] = "файлы",
        ["L_StatClean"] = "без изменений",
        ["L_StatChanges"] = "изменено: {0}",
        ["L_StatLastActivity"] = "активность",
        ["L_StatJustNow"] = "только что",
        ["L_StatMinutesAgo"] = "{0} мин назад",
        ["L_StatHoursAgo"] = "{0} ч назад",
        ["L_StatDaysAgo"] = "{0} дн назад",
        ["L_SourcesTitle"] = "ИСТОЧНИКИ",
        ["L_SourcesAdd"] = "Добавить",
        ["L_SourcesNone"] = "Нет привязанных источников. Добавь папку, решение Visual Studio или репозиторий GitHub.",
        ["L_SourceLocal"] = "Локальная папка…",
        ["L_SourceVs"] = "Visual Studio…",
        ["L_SourceGitHub"] = "GitHub…",
        ["L_SourceOpen"] = "Открыть",
        ["L_SourceRemove"] = "Убрать",
        ["L_SourceOpenVs"] = "Открыть в Visual Studio",
        ["L_SourceClone"] = "Клонировать в проект",
        ["L_SourceAddBtn"] = "Добавить",
        ["L_Publish"] = "Опубликовать",
        ["L_ProjectPublishing"] = "Публикация…",
        ["L_ProjectPublished"] = "Опубликовано.",
        ["L_ProjectPublishFailed"] = "Ошибка публикации.",
        ["L_StatLoc"] = "строк кода",
        ["L_StatComplexity"] = "сложность",
        ["L_StatConnections"] = "связи",
        ["L_StatNodes"] = "узлов",
        ["L_StatIsolated"] = "без связей",
        ["L_StatTopNode"] = "центральный",
        ["L_CxLow"] = "Низкая",
        ["L_CxMedium"] = "Средняя",
        ["L_CxHigh"] = "Высокая",
        ["L_CxVeryHigh"] = "Очень высокая",
        ["L_PublishTitle"] = "Публикация в GitHub",
        ["L_PublishConfirm"] = "Опубликовать папку проекта в новый ПРИВАТНЫЙ репозиторий GitHub «{0}»?",
        ["L_PublishRepoFailed"] = "Не удалось создать репозиторий. Токену нужен доступ на запись репозиториев.",
        ["L_PublishDone"] = "Опубликовано в {0}.",
        ["L_PublishUpdate"] = "Обновить",
        ["L_UpdateConfirm"] = "Закоммитить и запушить изменения проекта в «{0}»?",
        ["L_UpdateDone"] = "Запушено в {0}.",
        ["L_PubPublishTitle"] = "Публикация в GitHub",
        ["L_PubUpdateTitle"] = "Обновление в GitHub",
        ["L_PubName"] = "Имя репозитория",
        ["L_PubVisibility"] = "Видимость",
        ["L_PubPrivate"] = "Приватный",
        ["L_PubPublic"] = "Публичный",
        ["L_PubMessage"] = "Сообщение коммита",
        ["L_PubChanges"] = "Изменения ({0})",
        ["L_PubNoChanges"] = "Нет изменений для коммита.",
        ["L_PubUpdating"] = "Обновление {0}",
        ["L_PubImportAll"] = "Залить все файлы",
        ["L_PubImportAllHint"] = "Уходят все файлы, кроме сборки (bin, obj, .vs) — как публикует Visual Studio.",
        ["L_PubMetaOnlyHint"] = "Уходят только данные проекта: связи, описание, чаты и комнаты. Исходники остаются локально.",
        ["L_VsPickTitle"] = "Решения Visual Studio",
        ["L_VsPickHint"] = "Решения из папки source\\repos и недавнего списка Visual Studio.",
        ["L_VsPickNone"] = "Решения не найдены. Добавь папку как локальный источник.",
        ["L_GhDisconnect"] = "Выйти",
        ["L_GhTokenLabel"] = "Personal access token",
        ["L_GhConnect"] = "Подключить",
        ["L_GhTokenHint"] = "Создай токен с доступом на чтение репозиториев на ",
        ["L_GhLoading"] = "Загрузка репозиториев…",
        ["L_GhPrivate"] = "приватный",
        ["L_GhSettingsNote"] = "Войди в аккаунт, чтобы привязывать репозитории к проектам.",
        ["L_GhSignIn"] = "Войти через GitHub",
        ["L_GhSignInHint"] = "Откроется GitHub в браузере — не нужно создавать и вставлять токен.",
        ["L_GhOrToken"] = "ИЛИ ВОЙТИ ПО ТОКЕНУ",
        ["L_GhSignInTitle"] = "Вход в GitHub",
        ["L_GhDeviceIntro"] = "Откройте GitHub и введите этот код, чтобы подключить RedBloom:",
        ["L_GhDeviceOpen"] = "Открыть GitHub и скопировать код",
        ["L_GhDeviceStarting"] = "Запрашиваю код…",
        ["L_GhDeviceWaiting"] = "Жду подтверждения в браузере…",
        ["L_GhPickTitle"] = "Выбор репозитория",
        ["L_GhNotConnected"] = "Вы не вошли. Сначала подключите аккаунт GitHub в параметрах.",
        ["L_GhReauth"] = "Вход в GitHub истёк. Откройте параметры и войдите заново. (Если токен протухает постоянно — снимите галку «Expire user authorization tokens» в вашем OAuth App на GitHub.)",
        ["L_GhNoRepos"] = "Репозитории для этого аккаунта не найдены.",
        ["L_GraphNode"] = "Узел",
        ["L_GraphNote"] = "Заметка",
        ["L_GraphLabel"] = "Подпись",
        ["L_GraphDesc"] = "Описание",
        ["L_GraphConnection"] = "Связь",
        ["L_GraphWidth"] = "Толщина",
        ["L_GraphDashed"] = "Пунктир",
        ["L_GraphArrow"] = "Стрелка (направление)",
        ["L_GraphColor"] = "Цвет",
        ["L_GraphCustomColor"] = "Свой цвет",
        ["L_GraphRemoveColor"] = "Удалить цвет",
        ["L_GraphExport"] = "Экспортировать картинкой",
        ["L_GraphDefault"] = "По умолчанию",
        ["L_GraphOpen"] = "Открыть",
        ["L_GraphFit"] = "Вписать",
        ["L_GraphHint"] = "Тяни от точки узла, чтобы связать. Клик по узлу или линии — редактировать.",
        ["L_GraphKindNote"] = "Заметка",
        ["L_GraphKindChat"] = "Чат",
        ["L_GraphKindRoom"] = "Комната",
        ["L_GraphKindFile"] = "Файл",
        ["L_GraphKindSource"] = "Источник",
        ["L_GraphKindFolder"] = "Папка",
        ["L_GraphKindMilestone"] = "Веха",
        ["L_RoomTitle"] = "Комната",
        ["L_RoomName"] = "Название",
        ["L_RoomParticipants"] = "Участники",
        ["L_RoomAddModel"] = "＋ Модель",
        ["L_RoomAddModelTip"] = "Добавить копию агента под другую модель, только для этой комнаты",
        ["L_RoomAddModelNone"] = "Нет эндпоинт-агентов для копии. Сначала добавь на вкладке ИИ.",
        ["L_RoomAvatarNone"] = "нет картинки",
        ["L_RoomKindImage"] = "картинки",
        ["L_RoomKindLocal"] = "локальная",
        ["L_RoomEarlierSummary"] = "(ранняя часть беседы сжата)",
        ["L_RoomContextPerTurn"] = "Контекст / ход",
        ["L_RoomAllowCommands"] = "Разрешить агентам команды",
        ["L_RoomAllowCommandsNote"] = "Участники комнаты смогут выполнять команды на машине. Выключено, пока не включишь.",
        ["L_RoomAskBeforeRun"] = "Спрашивать перед каждой командой",
        ...
        ["L_RoomQueued"] = "В очереди — отправится, когда закончится текущий обмен.",
        ...
        ["L_ChatOpenTab"] = "Открыть",
        ["L_ChatExportMd"] = "Экспорт в Markdown…",
        ["L_ChatOpenWorkspace"] = "Открыть папку чата",
        ["L_ChatCardStyle"] = "Оформление…",
        ["L_ChatExported"] = "Чат экспортирован.",
        ...
        ["L_Extensions"] = "Расширения",
        ["L_ExtensionsNote"] = "Дополнения, расширяющие RedBloom. Включите нужное и откройте его в отдельной вкладке.",
        ["L_ExtEnabled"] = "Включено",
        ["L_ExtOpen"] = "Открыть",
        ["L_ExtDocs"] = "Документация",
        ["L_ExtFolder"] = "Папка расширений",
        ["L_ExtNone"] = "Расширения не найдены. Положите папку с расширением в папку расширений.",
        ["L_ExtBuiltIn"] = "встроенное",
        ["L_ExtUser"] = "пользовательское",
        ...
        ["L_ChatDropFiles"] = "Отпустите файлы, чтобы прикрепить",
        ["L_ChatRevert"] = "Откатить",
        ["L_ChatReverted"] = "Откачено",
        ...
        ["L_ChatAskPlaceholder"] = "Свой вариант ответа…",
        ["L_ChatAskSend"] = "Отправить",
        ...
        ["L_ChatCmdExport"] = "экспорт",
        ["L_ChatCmdExportHint"] = "Сохранить чат в Markdown-файл",
        ["L_ChatExportTitle"] = "Экспорт чата",
        ["L_ChatExportYou"] = "Вы",
        ["L_ChatExportEmpty"] = "Пока нечего экспортировать.",
        ["L_ChatExported"] = "Экспортировано в {0}.",
        ["L_ChatExportedProject"] = "Экспортировано в проект · {0}.",
        ["L_ChatExportFailed"] = "Не удалось экспортировать: {0}",
        ["L_ChatCtxCopy"] = "Копировать",
        ["L_ChatCtxImage"] = "Копировать картинкой",
        ["L_ChatCtxGoToFile"] = "Перейти к файлу",
        ...
        ["L_ChatReply"] = "Ответить этому",
        ["L_ChatQuoteMe"] = "Вы",
        ["L_ChatMentionAll"] = "Все",
        ["L_ChatMentionAllTitle"] = "Снова обращаться ко всем",
        ["L_ChatEarlier"] = "Показать ранние ({0})",
        ["L_ChatEditing"] = "редактирование",
        ["L_ChatCancelEdit"] = "Отмена",
        ["L_ChatCompacting"] = "Сжимаю историю…",
        ["L_TasksButton"] = "Задачи",
        ["L_TaskAgentButton"] = "Блокноты агентов",
        ["L_TaskAgentNone"] = "У этого агента пока нет задач.",
        ["L_TaskFilterOpen"] = "Не выполнено",
        ["L_TaskAdd"] = "Добавить",
        ["L_TaskDelete"] = "Удалить",
        ["L_TaskShareOne"] = "Поделиться задачей с агентом",
        ["L_TaskShareAll"] = "Поделиться всеми",
        ["L_TaskShareHeader"] = "Вот список задач:",
        ["L_TaskNone"] = "Задач пока нет.",
        ["L_TaskNamePh"] = "Название задачи",
        ["L_TaskDescPh"] = "Описание",
        ["L_TaskUnassigned"] = "— никто —",
        ["L_TaskNotStarted"] = "Не начато",
        ["L_TaskInProgress"] = "Выполняется",
        ["L_TaskDone"] = "Готово",
        ["L_TaskNeedsRework"] = "Требует доработки",
        ["L_TaskTests"] = "Тесты",
        ["L_ChatNoSsh"] = "Нет сохранённых SSH-подключений для прикрепления.",
        ["L_ChatCompactNothing"] = "Пока что сжимать особо нечего.",
        ["L_ChatTrimmed"] = "Самая ранняя часть чата отброшена, чтобы уместиться в контекст модели.",
        ...
        ["L_PhaseReadingFile"] = "читаю файл",
        ["L_PhaseWritingFile"] = "правлю файл",
        ["L_PhaseTasks"] = "обновляю список задач",
        ...
        ["L_PhaseReconnecting"] = "сбой у провайдера — переподключаюсь",
        ["L_FitGood"] = "потянет",
        ["L_FitTight"] = "впритык",
        ["L_FitHeavy"] = "тяжело",
        ["L_FitNo"] = "не потянет",
    ...
    /// <summary>Whether the app is currently showing Russian, for code (and extensions) that localize themselves.</summary>
    public static bool IsRussian => _current == AppLanguage.Russian;
